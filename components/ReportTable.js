    ...
    return (
        <>
            {CookieStands.length === 0 ? (
                <p className="text-center text-green-100">Report table is Empty...</p>
            ) : (
                <table className="mx-auto mt-4 border border-green-100">
                    <caption className="mb-2 text-lg font-semibold text-center text-green-100">Report Table</caption>
